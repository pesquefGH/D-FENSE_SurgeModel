...
%clear all; close all; clc  % clears workspace
...
dcases_orig=dcases;  % stores the original time-series up to EW 52 of 2023
...
% up to EW 39 of 2022 (including)


% Note: dcases_rec goes to EW 39 of 2022, i.e., it includes a
% 'deterministic' forecast of EW 26 to EW 39 of 2022
forecast_determ=dcases_rec(ind_EW25_2022+1:end);
...
% Note that forecast surge from EW 26 to 39 of 2022 may be best taken from the fitted
% surge around EW 15 of 2022.
...
median_cases=mean_cases_forecast(1+(1:52)); % median forecast from EW 41 2022 to EW 40 2023
...
figure
subplot(221)
plot(EW_index,cases,'linewidth',2); % plot known sequence of cases from EW 41 2022 up to EW 40 of 2023
hold on;
...
print(['..\plots\Validation1_SModel_',UF],'-dpdf')
